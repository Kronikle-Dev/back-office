...
const isUrl = props.resource.resourceType.length == 0 || props.resource.resourceType == KResourceType.url

</script>

<template>
  <div>
    <svg v-if="isUrl" class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
